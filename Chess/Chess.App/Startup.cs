using Chess.App.Server.Extensions;
using Chess.App.Server.Services;
using Chess.App.Server.SignalR;
...
namespace Chess.App
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Chess.App", Version = "v1" });
            });
        }
            ...
            app.UseSpa(spa =>
                      {
                          ...
                          // [1] In Chess.App.csproj, change the <BuildServerSideRenderer> property
